        ...
        <div class="container">
            <div class="details-banner-wrapper">
                <div class="details-banner-thumb">
                    <img src="{{ asset('frontend/assets/images/movie/venus.jpg') }}" alt="movie">
                    <a href="https://www.youtube.com/embed/KGeBMAgc46E" class="video-popup">
                        <img src="{{ asset('frontend/assets/images/movie/video-button.png') }}" alt="movie">
                    </a>
                </div>
                        ...
                        <div class="details-photos owl-carousel">
                            <div class="thumb">
                                <a href="assets/images/movie/movie-details01.jpg" class="img-pop">
                                    <img src="{{ asset('frontend/assets/images/movie/movie-details01.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="assets/images/movie/movie-details02.jpg" class="img-pop">
                                    <img src="{{ asset('frontend/assets/images/movie/movie-details02.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="assets/images/movie/movie-details03.jpg" class="img-pop">
                                    <img src="{{ asset('frontend/assets/images/movie/movie-details03.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="assets/images/movie/movie-details01.jpg" class="img-pop">
                                        ...
                                        <div class="casting-slider owl-carousel">
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast01.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast02.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast03.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast04.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider-two owl-carousel">
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast05.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast06.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast07.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ asset('frontend/assets/images/cast/cast08.jpg') }}" alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
