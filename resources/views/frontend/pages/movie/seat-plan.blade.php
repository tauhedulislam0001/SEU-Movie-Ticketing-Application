...
@section('content')
    ...
    <!-- ==========Banner-Section========== -->
    <section class="details-banner hero-area bg_img seat-plan-banner" data-background="{{ asset('frontend/assets/images/banner/banner04.jpg') }}">
        <div class="container">
        ...
        <div class="container">
            <div class="page-title-area">
                <div class="item md-order-1">
                    <a href="{{ route('movie.ticket-plan') }}" class="custom-button back-button">
                                ...
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="{{ asset('frontend/assets/images/movie/seat01.png') }}" alt="seat">
                                        </li>
                                        <li class="single-seat">
                                            <img src="{{ asset('frontend/assets/images/movie/seat01.png') }}" alt="seat">
                                        </li>
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free">
                                            <img src="{{ asset('frontend/assets/images/movie/seat01-free.png') }}" alt="seat">
                        ...
                        <li class="seat-line">
                            ...
                            <ul class="seat--area">
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="{{ asset('frontend/assets/images/movie/seat02.png') }}" alt="seat">
                                        </li>
                                        <li class="single-seat">
                                            <img src="{{ asset('frontend/assets/images/movie/seat02.png') }}" alt="seat">
                                        </li>
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free-two">
                                            <img src="{{ asset('frontend/assets/images/movie/seat02-booked.png') }}" alt="seat">
                        ...
                        <li class="seat-line">
                            ...
                            <ul class="seat--area">
                                ...
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat seat-free-two">
                                            <img src="{{ asset('frontend/assets/images/movie/seat02-free.png') }}" alt="seat">
