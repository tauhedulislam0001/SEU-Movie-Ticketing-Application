        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="c-thumb padding-bottom">
                    <img src="{{ asset('frontend/assets/images/sidebar/banner/banner04.jpg') }}" alt="sidebar/banner">
                </div>
                ...
                <div class="grid--area">
                    ...
                    <div class="grid-area">
                        <div class="grid-item combos popcorn">
                            <div class="grid-inner">
                                <div class="grid-thumb">
                                    <img src="{{ asset('frontend/assets/images/movie/popcorn/pop1.png') }}" alt="movie/popcorn">
                                    <div class="offer-tag">
                                        $57
                                    </div>
                        ...
                        <div class="grid-item bevarage">
                            <div class="grid-inner">
                                <div class="grid-thumb">
                                    <img src="{{ asset('frontend/assets/images/movie/popcorn/pop2.png') }}" alt="movie/popcorn">
                                    <div class="offer-tag">
                                        $57
                                    </div>
                                    <div class="offer-remainder">
                        ...
                        <div class="grid-item combos">
                            <div class="grid-inner">
                                <div class="grid-thumb">
                                    <img src="{{ asset('frontend/assets/images/movie/popcorn/pop3.png') }}" alt="movie/popcorn">
                                    <div class="offer-tag">
                                        $57
                                    </div>
                                    <div class="offer-remainder">
                        ...
                        <div class="grid-item bevarage popcorn">
                            <div class="grid-inner">
                                <div class="grid-thumb">
                                    <img src="{{ asset('frontend/assets/images/movie/popcorn/pop4.png') }}" alt="movie/popcorn">
                                    <div class="offer-tag">
                                        $57
                                    </div>
                                    <div class="offer-remainder">
