...
@section('content')
    ...
    <section class="window-warning inActive">
        ...
        <div class="warning-item">
            ...
            <div class="thumb">
                <img src="{{ asset('frontend/assets/images/movie/seat-plan.png') }}" alt="movie">
            </div>
    ...
    <!-- ==========Banner-Section========== -->
    <section class="details-banner hero-area bg_img" data-background="{{ asset('frontend/assets/images/banner/banner03.jpg') }}">
        <div class="container">
    ...
    <section class="book-section bg-one">
        <div class="container">
            <form class="ticket-search-form two">
                ...
                <div class="form-group">
                    <div class="thumb">
                        <img src="{{ asset('frontend/assets/images/ticket/exp.png') }}" alt="ticket">
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-10">
                    <div class="widget-1 widget-banner">
                        <div class="widget-1-body">
                            <a href="#0">
                                <img src="{{ asset('frontend/assets/images/sidebar/banner/banner03.jpg') }}" alt="banner">
                            </a>
                        </div>
                    </div>
                </div>
