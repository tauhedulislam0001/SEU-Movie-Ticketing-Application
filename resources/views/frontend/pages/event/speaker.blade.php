...
@section('content')
    ...
    <!-- ==========Banner-Section========== -->
    <section class="speaker-banner bg_img" data-background="{{ asset('frontend/assets/images/banner/banner07.jpg') }}">
        <div class="container">
        ...
        <div class="container">
            <div class="speaker-wrapper bg-six padding-top padding-bottom">
                <div class="speaker-thumb">
                    <img src="{{ asset('frontend/assets/images/speaker/speaker05.jpg') }}" alt="speaker">
                        ...
                        <div class="speak-con-area">
                            <div class="item">
                                ...
                                <div class="item-content">
                                    ...
                                    <a href="MailTo:hello@Boleto .com"><span class="__cf_email__" data-cfemail="48202d242427080a27242d3c27">[email&#160;protected]</span> .com</a>
                                </div>
                            </div>
