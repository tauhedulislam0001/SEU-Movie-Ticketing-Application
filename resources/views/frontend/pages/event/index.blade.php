...
<section class="banner-section">
    <div class="banner-bg bg_img" data-background="{{ asset('frontend/assets/images/banner/banner05.jpg') }}"></div>
    <div class="container">
                    ...
                    <div class="row mb-10 justify-content-center">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event04.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event05.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event06.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event07.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event08.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event09.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event10.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event11.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="event-details.html">
                                        <img src="{{ asset('frontend/assets/images/event/event12.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
