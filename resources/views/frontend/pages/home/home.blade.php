...
<section class="banner-section">
    <div class="banner-bg bg_img bg-fixed" data-background="{{ asset('frontend/assets/images/banner/banner01.jpg') }}"></div>
    <div class="container">
                ...
                <div class="widget-1 widget-facility">
                    <div class="widget-1-body">
                        <ul>
                            <li>
                                <a href="#0">
                                    <span class="img"><img src="{{ asset('frontend/assets/images/sidebar/icons/sidebar01.png') }}" alt="sidebar"></span>
                                    <span class="cate">24X7 Care</span>
                                </a>
                            </li>
                            <li>
                                <a href="#0">
                                    <span class="img"><img src="{{ asset('frontend/assets/images/sidebar/icons/sidebar02.png') }}" alt="sidebar"></span>
                                    <span class="cate">100% Assurance</span>
                                </a>
                            </li>
                            <li>
                                <a href="#0">
                                    <span class="img"><img src="{{ asset('frontend/assets/images/sidebar/icons/sidebar03.png') }}" alt="sidebar"></span>
                    ...
                    <div class="row mb-30-none justify-content-center">
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="#0">
                                        <img src="{{ asset('frontend/assets/images/event/event01.jpg') }}" alt="event">
                                    </a>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="#0">
                                        <img src="{{ asset('frontend/assets/images/event/event02.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="event-grid">
                                <div class="movie-thumb c-thumb">
                                    <a href="#0">
                                        <img src="{{ asset('frontend/assets/images/event/event03.jpg') }}" alt="event">
                                    </a>
                                    <div class="event-date">
                                        <h6 class="date-title">28</h6>
                                        <span>Dec</span>
